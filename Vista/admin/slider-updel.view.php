 ...
 <div class="capa-negra"></div>
  <header>
   <div class="titulo">
    ...
    <table class="table table-bordered">
        <thead class="bg-primary cabecera">
            <tr>
                ...
                <th colspan="5"><center>Lista de slider</center></th>
            </tr>
        </thead>
    ...
    <input type="text" REQUIRED placeholder="Nombre del slider" name="titulo">
    <label for="titulos">Descripcion:</label>
    <textarea REQUIRED placeholder="Descripcion del slider" name="descripcion"></textarea>
